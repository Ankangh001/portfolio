...
<body>
        ...
        <div class='container'>
            <div class='header section' id='header'>
                <div class='widget header' data-version='1' id='header1'>
                    <div id='header-inner'>
                        <a href="wa.me:9875509729" class='navbar-brand logo btn'>
                            Hire Me !
                        </a>
                    </div>
                </div>
            ...
            <div class='navbar-collapse collapse' id='navbarcollapse'>
                <ul class='navbar-nav ml-auto'>
                    ...
                    <li class='nav-item'>
                        <a class='nav-link' data-scroll-nav='3' href='#'>works</a>
                    </li>
                    <li class='nav-item'>
                        <a class='nav-link' data-scroll-nav='4' href='#'>blog</a>
                    </li>
                    <li class='nav-item'>
    ...
    <!--navbar end-->
    <!--home section start-->
    <section class='banner' data-scroll-index='0' data-stellar-background-ratio='.7' id='home'
        style="background-image: url({{ asset('images/background.jpg')}});">
        <div class='container'>
            <!--banner content-->
            <div class='banner-div'>
                <!-- header name -->
                <h1>hi! i'm <span>Ankan Ghosh</span></h1>
                <p class='cd-headline clip is-full-width'>
                    <span>professional in</span>
                    <!-- headline -->
                    <span class='cd-words-wrapper' style='width: 236.9px;'>
                        <b class='is-hidden'>web development.</b>
                        <b class='is-hidden'>Iot.</b>
                        <b class='is-hidden'>AI enthusiast.</b>
                        <b class='is-visible'>UI/UX Designer</b>
                        <b class='is-hidden'>wordpress.</b>
                    </span>
                </p>
                <!--about social icons-->
                <div class='social-icons mt-15'>
                    <a href='https://www.facebook.com/profile.php?id=100010670642319'><i
                            class='fab fa-facebook-f'></i></a>
                    <a href='https://www.instagram.com/art.world.with.ankan?r=nametag'><i
                            class='fab fa-instagram'></i></a>
                    <a href='https://github.com/ankangh001'><i class='fab fa-github'></i></a>
                    <a href='https://www.linkedin.com/in/ankan-ghosh-a21a83167/'><i class='fab fa-linkedin-in'></i></a>

                </div>
            </div>
            <div class='arrow bounce'>
                <a class='fa fa-chevron-down fa-2x' data-scroll-nav='1' href='#'></a>
            </div>
            <!-- Image with tooltip -->
            <a href="https://wa.me/your-whatsapp-number" target="_blank" class="whatsapp-link">
                <img id="banner-photo" src="{{ asset('images/bg.png') }}" />
            </a>
        </div>
    </section>
    <!--home section end-->
    <!--about section start-->
    <section class='about pt-100 pb-100' data-scroll-index='1' id='about'>
        <div class='container'>
            <div class='row'>
                <div class='col-lg-7 col-md-6'>
                    ...
                    <div class='about-div'>
                        ...
                        <p>Highly motivated and fast learner, always eager to stay aligned with emerging technologies. With expertise in full-stack web development, I have acquired a broad skill set in creating scalable, efficient, and high-performance web applications. My passion lies in delivering expert consulting solutions, guiding clients through the process of building robust digital platforms using modern technologies. I am experienced in both frontend and backend development, with proficiency in <b>HTML, CSS, JavaScript, PHP, React, Laravel, and CodeIgniter,</b> enabling me to provide end-to-end solutions. I thrive on collaborating with cross-functional teams and enjoy interacting with new people, fostering strong relationships while helping businesses achieve their objectives through innovative, technology-driven solutions.
                        </p>
                            ...
                            <table class='info-table'>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="tel:9875509729">+91 9875509729</a></td>
                                    </tr>
                                    <tr>
                                        <th>
                                        ...
                                        <td><a href="mailto:ankanghosh010@gmail.com?subject=Hello%20Ankan%20It's%20an%20Enquiry%20Quote&body=Hello%20Ankan,%0AI%20wanted%20to%20connect%20with%20you%20and%20wanted%20to%20have%20a%20one-on-one%20discussion">ankanghosh010@gmail.com</a></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <span class='about-btn'>
                            <a class='div-btn'
                                href='{{ asset("resume.pdf") }}'>download
                                cv</a>
                            <a class='div-btn' href="mailto:ankanghosh010@gmail.com?subject=Hello%20Ankan%20It's%20an%20Enquiry%20Quote&body=Hello%20Ankan,%0AI%20wanted%20to%20connect%20with%20you%20and%20wanted%20to%20have%20a%20one-on-one%20discussion">e-mail me</a>
                        </span>
                    </div>
                </div>
                <div class='col-lg-5 col-md-6'>
                    <!--about image-->
                    <div class='about-img'>
                        <img alt='' class='img-fluid' src="{{asset('images/my.jpg')}}" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                <div class='col-lg-6'>
                    <div class='skill-div'>
                        ...
                        <p>developing, compiling and debugging is the main skillset i can provide.</p>
                        <p>well i think, plan, work and learn from my mistakes to gain more knowledge. &#8220;experience
                            is the name
                            everyone gives to their mistakes.&#8221; &#8211; oscar wilde</p>
                    </div>
                </div>
                <div class='col-lg-6'>
                    <div class='skill-div '>
                        <div class='skills-item mb-35'>
                            <h6>c</h6>
                            <div class='bar'>
                                <span class='fill' data-width='60%'></span>
                            </div>
                            <div class='tip'></div>
                        </div>
                        <div class='skills-item mb-35'>
                        ...
                        <div class='skills-item mb-35'>
                            <h6>java script</h6>
                            <div class='bar'>
                                <span class='fill' data-width='88%'></span>
                            </div>
                            <div class='tip'></div>
                        </div>
                        <div class='skills-item mb-35'>
                        ...
                        <div class='skills-item mb-35'>
                            ...
                            <div class='tip'>Laravel 10, Codeignitor 4</div>
                        </div>
                        <div class='skills-item mb-35'>
                            <h6>IoT</h6>
                            <div class='bar'>
                            ...
                            <div class='tip'>Arduino, Node MCU</div>
                        </div>
    ...
    <section class='services pt-100 pb-100' data-scroll-index='2' id='services'>
        <div class='container'>
            <div class='row'>
                <div class='col'>
    ...
    <section class='portfolio bg-gray pt-100 pb-100' data-scroll-index='3' id='portfolio'>
        <div class='container'>
            <div class='row'>
                <div class='col'>
                    <div class='section-title'>
    ...
    <section class='blog pt-100 pb-100' data-scroll-index='4' id='blog'>
        <div class='container'>
            <div class='row'>
                                ...
                                <div class='row'>
                                    <div class='col-md-6'>
                                        <div class='form-group'>
                                            <input class='form-control' id='contactform1_contact-form-name' name='name'
                                                placeholder='name *' required='' type='text' />
                                        </div>
                                    </div>
                                    <div class='col-md-6'>
                                        <div class='form-group'>
                                            <input class='form-control' id='contactform1_contact-form-email'
                                                name='email' placeholder='email *' required='' type='email' />
                                        </div>
                                    </div>
                                    <div class='col-md-12'>
                                        <div class='form-group'>
                                            <textarea class='form-control' id='contactform1_contact-form-email-message'
                                                name='message' placeholder='message *' required='' rows='6'></textarea>
                                        </div>
                                    </div>
                                    <div class='col-md-12'>
                    ...
                    <div class='contact-info'>
                        ...
                        <div class='social-icons mt-15'>
                            ...
                            <a href='https://www.instagram.com/art.world.with.ankan?r=nametag'><i
                                    class='fab fa-instagram'></i></a>
                            <a href='https://github.com/ankangh001'><i class='fab fa-github'></i></a>
                            <a href='https://www.linkedin.com/in/ankan-ghosh-a21a83167/'><i
            ...
            <div class='row text-center'>
                <div class='col-md-12'>
                    <p class='copy pt-30'>
                        ...
                        designed by <a class='navbar-brand logo'>ankan ghosh</a>
                    </p>
                </div>
            </div>
        </div>
